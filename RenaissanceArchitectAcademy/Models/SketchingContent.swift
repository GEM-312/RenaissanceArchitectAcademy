...
///
/// AI-validated redesign (2026-04-22):
/// - `aerialImageName` — top-down photo/render of the real building (left side of canvas)
/// - `referencePlanImageName` — engineering floor plan (revealed under student canvas while peeking; the AI's comparison target)
///
/// Convention: imageset names are `{BuildingCamelCase}Aerial` and `{BuildingCamelCase}FloorPlan`.
/// If either imageset is missing from Assets.xcassets, the canvas shows a "Reference art coming soon"
...
enum SketchingContent {
    ...
    /// Reduces boilerplate for the 13 new buildings — they don't use legacy grid fields.
    private static func pianta(
        ...
        .pianta(PiantaPhaseData(
            ...
            aerialImageName: aerial,
            referencePlanImageName: referencePlan,
            targetRooms: [],
            targetColumns: [],
            symmetryAxis: nil,
            proportionalRatios: []
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: .pianta(PiantaPhaseData(
                    ...
                    targetRooms: [], targetColumns: [], symmetryAxis: nil, proportionalRatios: []
                ))
            )
        ],
    ...
    static let romanBathsSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "RomanBathsAerial",
                    referencePlan: "RomanBathsFloorPlan",
    ...
    static let romanRoadsSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "RomanRoadsAerial",
                    referencePlan: "RomanRoadsFloorPlan",
    ...
    static let siegeWorkshopSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "SiegeWorkshopAerial",
                    referencePlan: "SiegeWorkshopFloorPlan",
    ...
    static let botanicalGardenSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "BotanicalGardenAerial",
                    referencePlan: "BotanicalGardenFloorPlan",
    ...
    static let glassworksSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "GlassworksAerial",
                    referencePlan: "GlassworksFloorPlan",
    ...
    static let arsenalSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "ArsenalAerial",
                    referencePlan: "ArsenalFloorPlan",
    ...
    static let anatomyTheaterSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "AnatomyTheaterAerial",
                    referencePlan: "AnatomyTheaterFloorPlan",
    ...
    static let leonardoWorkshopSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "LeonardoWorkshopAerial",
                    referencePlan: "LeonardoWorkshopFloorPlan",
    ...
    static let flyingMachineSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "FlyingMachineAerial",
                    referencePlan: "FlyingMachineFloorPlan",
    ...
    static let vaticanObservatorySketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "VaticanObservatoryAerial",
                    referencePlan: "VaticanObservatoryFloorPlan",
    ...
    static let printingPressSketching = SketchingChallenge(
        ...
        phases: [
            SketchingPhase(
                ...
                phaseData: pianta(
                    aerial: "PrintingPressAerial",
                    referencePlan: "PrintingPressFloorPlan",
