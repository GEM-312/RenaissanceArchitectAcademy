        ...
        TeachingContainer(title: visual.title, color: color, totalSteps: 3,
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    if step >= 2 {
                        ForEach(0..<rooms.count, id: \.self) { i in
                            ...
                            RoundedRectangle(cornerRadius: 4)
                                .fill(discovered ? rooms[i].color.opacity(0.2) : stoneGray.opacity(0.08))
                                .frame(width: cellW - 6, height: cellH - 6)
                                .overlay(
                                    RoundedRectangle(cornerRadius: 4)
                                        .strokeBorder(discovered ? rooms[i].color.opacity(0.4) : stoneGray.opacity(0.2), lineWidth: 1)
                                )
                                .overlay {
                                    if discovered {
                                        VStack(spacing: 2) {
                    ...
                    if step >= 3 {
                        FormulaText(text: "6 rooms — one ticket — almost free", highlighted: true, fontSize: 11)
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    RoundedRectangle(cornerRadius: 3)
                        .fill(heatPhase >= 1 ? hotRed.opacity(0.4) : stoneGray.opacity(0.2))
                    ...
                    if heatPhase >= 1 {
                        ...
                        ForEach(0..<3, id: \.self) { i in
                            Image(systemName: "arrow.right")
                                .font(.system(size: 8))
                                .foregroundStyle(hotRed.opacity(0.5))
                    ...
                    // Labels
                    DimLabel(text: "Floor", fontSize: 8)
                        .position(x: w * 0.87, y: floorY - 8)
                    DimLabel(text: "Pilae", fontSize: 8)
                    ...
                    if step >= 2 && heatPhase < 3 {
                        Button {
                            ...
                            .background(hotRed.opacity(0.1)).cornerRadius(6)
                        }
                        .buttonStyle(.plain)
                    ...
                    if step >= 3 {
                        FormulaText(text: "Full circuit: furnace → floor → walls → roof", highlighted: true, fontSize: 10)
                            .position(x: cx, y: h * 0.88)
                            .transition(.opacity)
                    }
                }
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    ForEach(0..<3, id: \.self) { i in
                        ...
                        .stroke(outlet.active ? outlet.color : stoneGray.opacity(0.3), lineWidth: 3)
                        ...
                        Text(outlet.name)
                            ...
                            .foregroundStyle(outlet.active ? outlet.color : sepiaInk.opacity(0.3))
                            .position(x: pipeEndX + 25, y: oy)

                        if !outlet.active {
                            Text("OFF")
                                .font(.custom("EBGaramond-Bold", size: 7))
                    ...
                    if step >= 3 {
                        FormulaText(text: "Gravity rations — no valves needed", highlighted: true, fontSize: 11)
                            .position(x: cx, y: h * 0.88)
                            .transition(.opacity)
                    }
                }
                ...
                ZStack {
                    ...
                    if !visitedRooms.isEmpty {
                        HStack(spacing: 0) {
                            ForEach(0..<3, id: \.self) { i in
                                Rectangle()
                                    .fill(visitedRooms.contains(i) ? bathRooms[i].color.opacity(0.3) : stoneGray.opacity(0.05))
                            ...
                            ForEach(0..<3, id: \.self) { i in
                                ...
                                VStack(spacing: 6) {
                                    Text(room.name)
                                        ...
                                        .foregroundStyle(visited ? room.color : sepiaInk.opacity(0.4))

                                    RoundedRectangle(cornerRadius: 6)
                                        .fill(visited ? room.color.opacity(0.15) : stoneGray.opacity(0.06))
                                        .frame(width: roomW, height: roomH)
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 6)
                                                .strokeBorder(visited ? room.color.opacity(0.4) : stoneGray.opacity(0.2), lineWidth: 1)
                                        )
                                        .overlay {
                                            if visited {
                                                VStack(spacing: 4) {
                    ...
                    if step >= 3 {
                        FormulaText(text: "15°C → 28°C → 40°C — gradual acclimatization", highlighted: true, fontSize: 10)
        ...
        TeachingContainer(title: visual.title, color: color, totalSteps: 3,
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    .stroke(stoneGray.opacity(0.4), lineWidth: 2)

                    DimLabel(text: "Cloaca Maxima", fontSize: 8)
                        .position(x: w * 0.85, y: h * 0.7)

                    // Slope annotation
                    DimLabel(text: "2% slope", fontSize: 9)
                    ...
                    if flowStarted {
                        Canvas { context, size in
                            for i in 0..<6 {
                                ...
                                context.fill(Path(ellipseIn: rect), with: .color(waterBlue.opacity(0.6)))
                            }
                        }
                    ...
                    if step >= 2 && !flowStarted {
                        Button {
                            ...
                            HStack(spacing: 4) {
                                ...
                                Text("Open Drain").font(.custom("EBGaramond-SemiBold", size: 12))
                            }
                    ...
                    if step >= 3 {
                        FormulaText(text: "Zero waste — drain reused for latrines", highlighted: true, fontSize: 11)
                            .position(x: cx, y: h * 0.85)
                            .transition(.opacity)
                    }
                }
...
private struct BathWallLayersVisual: View {
    ...
    private let layers: [(name: String, color: Color, desc: String)] = [
        ("Marble veneer", marbleWhite, "Beauty"),
        ("Opus signinum", RenaissanceColors.terracotta.opacity(0.5), "Waterproof"),
        ("Concrete core", stoneGray, "Structure"),
    ]
        ...
        TeachingContainer(title: visual.title, color: color, totalSteps: 3,
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    ForEach(0..<revealedLayers, id: \.self) { i in
                        HStack(spacing: 4) {
                            ...
                            VStack(alignment: .leading, spacing: 1) {
                                Text(layers[i].name).font(.custom("Cinzel-Bold", size: 8))
                                Text(layers[i].desc).font(.custom("EBGaramond-Regular", size: 8)).foregroundStyle(sepiaInk.opacity(0.5))
                            }
                        }
                    ...
                    if step >= 2 && revealedLayers < 3 {
                        Button {
                            ...
                            HStack(spacing: 4) {
                                ...
                                Text("Peel Layer").font(.custom("EBGaramond-SemiBold", size: 12))
                            }
                    ...
                    if step >= 3 {
                        FormulaText(text: "Beauty → Waterproof → Structure", highlighted: true, fontSize: 11)
                            .position(x: cx, y: h * 0.85)
                            .transition(.opacity)
                    }
                }
...
private struct BathConcreteVisual: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 10) {
                FormulaText(text: "1 Lime : 4 Pozzolana (extra silica)", highlighted: scoops >= 5, fontSize: 13)
                    .padding(.top, 8)
                ...
                GeometryReader { geo in
                    ...
                    HStack(spacing: 2) {
                        RoundedRectangle(cornerRadius: 3)
                            .fill(scoops >= 1 ? Color.white.opacity(0.6) : stoneGray.opacity(0.15))
                            .frame(width: barW * 0.2)
                        RoundedRectangle(cornerRadius: 3)
                            .fill(scoops >= 2 ? Color(red: 0.65, green: 0.40, blue: 0.30).opacity(CGFloat(min(scoops - 1, 4)) * 0.2) : stoneGray.opacity(0.15))
                ...
                if scoops < 5 {
                    HStack(spacing: 16) {
                        Button {
                            ...
                            Text("+ Lime").font(.custom("EBGaramond-SemiBold", size: 12))
                                .padding(.horizontal, 12).padding(.vertical, 6)
                                .background(scoops >= 1 ? stoneGray.opacity(0.1) : Color.white.opacity(0.3))
                                .cornerRadius(6)
                        ...
                        Button {
                            ...
                            Text("+ Pozzolana").font(.custom("EBGaramond-SemiBold", size: 12))
                                .padding(.horizontal, 12).padding(.vertical, 6)
                                .background(Color(red: 0.65, green: 0.40, blue: 0.30).opacity(0.15))
                                .cornerRadius(6)
                                .overlay(RoundedRectangle(cornerRadius: 6).stroke(scoops >= 1 && scoops < 5 ? color : stoneGray.opacity(0.2), lineWidth: scoops >= 1 && scoops < 5 ? 2 : 0.5))
                        }
                ...
                if healed {
                    FormulaText(text: "Extra silica fills cracks automatically", highlighted: true, fontSize: 11)
                }
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    Text(isMolten ? "Molten glass" : isMelting ? "Melting..." : "Sand (SiO₂)")
                        ...
                        .foregroundStyle(isMolten ? RenaissanceColors.sageGreen : sepiaInk)
                    ...
                    Text("\(tempC)°C")
                        ...
                        .monospacedDigit()
                        .foregroundStyle(isMolten ? RenaissanceColors.sageGreen : (tempC > 600 ? .orange : sepiaInk))
                    ...
                    if step >= 3 {
                        FormulaText(text: "Pour flat → thick window → light floods in", highlighted: true, fontSize: 11)
                            .position(x: cx, y: h * 0.85)
                            .transition(.opacity)
                    }
                }
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    Text("\(tons) tons")
                        ...
                        .foregroundStyle(isOverloaded ? RenaissanceColors.errorRed : sepiaInk)
                    ...
                    DimLabel(text: "25 m span", fontSize: 9)
                        .position(x: cx, y: h * 0.66)

                    if step >= 3 {
                        FormulaText(text: "Depth = span ÷ 20 = 1.25 m", highlighted: true, fontSize: 11)
                            .position(x: cx, y: h * 0.85)
                            .transition(.opacity)
                    }
                }
        ...
        TeachingContainer(title: visual.title, color: color, totalSteps: 3,
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    if showGradient {
                        LinearGradient(
                            colors: [hotRed, warmOrange, Color(red: 0.95, green: 0.85, blue: 0.70)],
                            startPoint: .leading,
                            endPoint: .trailing
                        )
                        ...
                        HStack {
                            Text("300°C").font(.custom("EBGaramond-Bold", size: 11)).foregroundStyle(hotRed)
                            Spacer()
                            Text("120°C").font(.custom("EBGaramond-Regular", size: 10)).foregroundStyle(warmOrange)
                            Spacer()
                            Text("40°C").font(.custom("EBGaramond-Bold", size: 11)).foregroundStyle(sepiaInk)
                        }
                        .frame(width: w * 0.65)
                    ...
                    Image(systemName: showGradient ? "flame.fill" : "flame")
                        .font(.system(size: 24))
                        .foregroundStyle(showGradient ? hotRed : stoneGray.opacity(0.3))
                    ...
                    if step >= 2 && !showGradient {
                        Button {
                            ...
                            HStack(spacing: 4) {
                                ...
                                Text("Light Furnace").font(.custom("EBGaramond-SemiBold", size: 12))
                            }
                            .foregroundStyle(hotRed)
                            .padding(.horizontal, 12).padding(.vertical, 6)
                            .background(hotRed.opacity(0.1)).cornerRadius(6)
                    ...
                    if step >= 3 {
                        FormulaText(text: "Distance controls temperature — no thermostat needed", highlighted: true, fontSize: 10)
                            .position(x: cx, y: h * 0.85)
                            .transition(.opacity)
                    }
                }
...
private struct GlassRecipeVisual: View {
    ...
    private var crucibleColor: Color {
        ...
        case 0: return stoneGray.opacity(0.15)
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 10) {
                FormulaText(text: "60% Silica + 15% Natron + 10% Lime + 15% Cullet", highlighted: ingredientsAdded >= 4, fontSize: 11)
                    .padding(.top, 8)
                    ...
                    HStack(spacing: 8) {
                        ForEach(0..<4, id: \.self) { i in
                            ...
                            Button {
                                ...
                                VStack(spacing: 1) {
                                    Text(ingredients[i].pct).font(.custom("EBGaramond-Bold", size: 11))
                                    Text(ingredients[i].name).font(.custom("EBGaramond-Regular", size: 8))
                                }
                                .frame(width: 55, height: 38)
                                .background(isDone ? stoneGray.opacity(0.1) : ingredients[i].color.opacity(0.2))
                                .cornerRadius(4)
                                .overlay(RoundedRectangle(cornerRadius: 4).stroke(isNext ? color : stoneGray.opacity(0.2), lineWidth: isNext ? 2 : 0.5))
                                .foregroundStyle(isDone ? sepiaInk.opacity(0.3) : sepiaInk)
                            }
                            .buttonStyle(.plain)
                ...
                if ingredientsAdded >= 4 {
                    ...
                    FormulaText(text: "1,100°C → clear Roman glass", highlighted: true, fontSize: 12)
                }
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    ForEach(0..<arrowCount, id: \.self) { i in
                        ...
                        Image(systemName: "arrow.right")
                            .font(.system(size: CGFloat(6 + narrowing * 6)))
                            .foregroundStyle(isOptimal ? hotRed.opacity(0.5) : warmOrange.opacity(0.4))
                    ...
                    if narrowing > 0.3 {
                        Image(systemName: "flame.fill")
                            .font(.system(size: 10 + narrowing * 12))
                            .foregroundStyle(hotRed.opacity(0.4 + narrowing * 0.4))
                    ...
                    if step >= 2 {
                        ...
                        HStack {
                            Text("Wide").font(.custom("EBGaramond-Regular", size: 8))
                            Spacer()
                            Text("Narrow").font(.custom("EBGaramond-Regular", size: 8))
                        }
                    ...
                    if step >= 3 {
                        FormulaText(text: "Narrow = fast air = hotter fire", highlighted: true, fontSize: 11)
        ...
        TeachingContainer(title: visual.title, color: color, totalSteps: 3,
            ...
            GeometryReader { geo in
                ...
                ZStack {
                    ...
                    .fill(layersAdded >= 1 ? RenaissanceColors.terracotta.opacity(0.3) : stoneGray.opacity(0.15))
                    ...
                    .stroke(layersAdded >= 1 ? RenaissanceColors.terracotta : stoneGray, lineWidth: 1.5)
                    ...
                    ForEach(0..<layersAdded, id: \.self) { i in
                        HStack(spacing: 4) {
                            ...
                            Text(parts[i].name).font(.custom("EBGaramond-Regular", size: 9))
                        }
                        .foregroundStyle(sepiaInk)
                    ...
                    if step >= 2 && layersAdded < 3 {
                        Button {
                            ...
                            HStack(spacing: 4) {
                                ...
                                Text("Add \(parts[layersAdded].name)").font(.custom("EBGaramond-SemiBold", size: 11))
                            }
                            .foregroundStyle(color)
                            .padding(.horizontal, 12).padding(.vertical, 6)
                            .background(color.opacity(0.1)).cornerRadius(6)
                    ...
                    if step >= 3 {
                        FormulaText(text: "Sealed, waterproof, airtight", highlighted: true, fontSize: 11)
                            .position(x: cx, y: h * 0.85)
                            .transition(.opacity)
                    }
                }
