...
struct CardVisualView: View {
    ...
    private func drawReaction(context: GraphicsContext, size: CGSize) {
        ...
        if visual.labels.count > 2 {
            context.draw(
                Text(visual.labels[2]).font(RenaissanceFont.italicSmall).foregroundColor(color),
        ...
        if let key = visual.values.keys.first, let val = visual.values[key] {
            ...
            context.draw(
                Text(annotation).font(RenaissanceFont.bodySmall).foregroundColor(sepiaInk.opacity(0.6)),
    ...
    private func drawCrossSection(context: GraphicsContext, size: CGSize) {
        ...
        for i in 0..<visibleLayers {
            ...
            context.draw(
                Text(visual.labels[i]).font(RenaissanceFont.buttonSmall).foregroundColor(sepiaInk),
        ...
        if visibleLayers > 0, let totalVal = visual.values["depth"] ?? visual.values["height"] {
            ...
            context.draw(
                Text(String(format: "%.1f m", shownDepth)).font(RenaissanceFont.buttonSmall).foregroundColor(color),
    ...
    private func drawDomeLayers(context: GraphicsContext, size: CGSize) {
        ...
        for i in 0..<visibleLayers {
            ...
            context.draw(
                Text(visual.labels[i]).font(RenaissanceFont.bodySmall).foregroundColor(sepiaInk),
    ...
    private func drawGeometry(context: GraphicsContext, size: CGSize) {
        ...
        // "sphere" label
        context.draw(
            Text("perfect sphere").font(RenaissanceFont.italicSmall).foregroundColor(RenaissanceColors.renaissanceBlue.opacity(0.6)),
        ...
        if let diameter = visual.values["diameter"] {
            ...
            context.draw(
                Text("\(diameter.formatted()) m").font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        if let height = visual.values["height"] {
            ...
            context.draw(
                Text("\(height.formatted()) m").font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        context.draw(
            Text("height = diameter").font(RenaissanceFont.buttonSmall).foregroundColor(color),
    ...
    private func drawTessellation(context: GraphicsContext, size: CGSize) {
        ...
        for i in 0..<visibleStones {
            ...
            if i < visual.labels.count {
                context.draw(
                    Text(visual.labels[i]).font(RenaissanceFont.bodySmall).foregroundColor(sepiaInk.opacity(0.7)),
    ...
    private func drawChorobatesBeam(context: GraphicsContext, size: CGSize) {
        ...
        context.draw(
            Text("6 meters").font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        context.draw(
            Text(slopeLabel).font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        context.draw(
            Text("tiny drop").font(RenaissanceFont.italicSmall).foregroundColor(Color.red.opacity(0.5)),
    ...
    private func drawRatio(context: GraphicsContext, size: CGSize) {
        ...
        if visual.labels.count >= 1 {
            context.draw(
                Text(visual.labels[0]).font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        context.draw(
            Text(firstEntry.key).font(RenaissanceFont.buttonSmall).foregroundColor(sepiaInk),
        ...
        for i in 1..<sortedValues.count {
            ...
            context.draw(
                Text(entry.key).font(RenaissanceFont.buttonSmall).foregroundColor(sepiaInk),
        ...
        for entry in sortedValues {
            ...
            context.draw(
                Text("\(pct)%").font(RenaissanceFont.buttonSmall).foregroundColor(color.opacity(0.7)),
    ...
    private func drawTemperature(context: GraphicsContext, size: CGSize) {
        ...
        // Y axis label
        context.draw(
            Text("°C").font(RenaissanceFont.buttonSmall).foregroundColor(sepiaInk.opacity(0.6)),
        ...
        context.draw(
            Text("\(Int(transitionTemp))°C").font(RenaissanceFont.buttonSmall).foregroundColor(Color.red.opacity(0.7)),
        ...
        if visual.labels.count >= 2 {
            context.draw(
                Text(visual.labels[0]).font(RenaissanceFont.italicSmall).foregroundColor(sepiaInk.opacity(0.5)),
                at: CGPoint(x: pad + graphW * 0.15, y: h - pad + 12)
            )
            context.draw(
                Text(visual.labels[1]).font(RenaissanceFont.italicSmall).foregroundColor(sepiaInk.opacity(0.5)),
    ...
    private func drawForce(context: GraphicsContext, size: CGSize) {
        ...
        // "×16" label
        context.draw(
            Text("×16 columns").font(RenaissanceFont.italicSmall).foregroundColor(sepiaInk.opacity(0.5)),
        ...
        if let colHeight = visual.values["height"] {
            context.draw(
                Text("\(Int(colHeight))m tall").font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        if let perCol = visual.values["perColumn"] {
            context.draw(
                Text("\(Int(perCol)) tons each").font(RenaissanceFont.buttonSmall).foregroundColor(color),
    ...
    private func drawOculusCompression(context: GraphicsContext, size: CGSize) {
        ...
        if let diameter = visual.values["diameter"] {
            context.draw(
                Text("\(Int(diameter))m").font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        // "Compression" label
        context.draw(
            Text("compression").font(RenaissanceFont.italicSmall).foregroundColor(Color.orange.opacity(0.7)),
        ...
        for (i, label) in visual.labels.enumerated() {
            context.draw(
                Text(label).font(RenaissanceFont.italicSmall).foregroundColor(sepiaInk.opacity(0.6)),
    ...
    private func drawVoussoirArch(context: GraphicsContext, size: CGSize) {
        ...
        context.draw(
            Text("keystone").font(RenaissanceFont.italicSmall).foregroundColor(color),
        ...
        context.draw(
            Text("compression").font(RenaissanceFont.italicSmall).foregroundColor(Color.red.opacity(0.5)),
        ...
        if let height = visual.values["height"] {
            ...
            context.draw(
                Text("\(Int(height))m").font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        context.draw(
            Text("voussoir").font(RenaissanceFont.italicSmall).foregroundColor(sepiaInk.opacity(0.5)),
    ...
    private func drawScaffolding(context: GraphicsContext, size: CGSize) {
        ...
        // "poplar" label
        context.draw(
            Text("poplar").font(RenaissanceFont.italicSmall).foregroundColor(wood.opacity(0.5)),
        ...
        context.draw(
            Text("43m").font(RenaissanceFont.buttonSmall).foregroundColor(color),
    ...
    private func drawCoffers(context: GraphicsContext, size: CGSize) {
        ...
        // "28 rows" label
        context.draw(
            Text("28 rows of coffers").font(RenaissanceFont.italicSmall).foregroundColor(sepiaInk.opacity(0.5)),
        ...
        context.draw(
            Text("each panel removes ~2 tons").font(RenaissanceFont.italicSmall).foregroundColor(color),
        ...
        // Labels on bars
        context.draw(
            Text("4,535 t (with coffers)").font(RenaissanceFont.buttonSmall).foregroundColor(color),
            at: CGPoint(x: centerX - barW / 2 + reducedW / 2, y: barY + barH / 2)
        )

        // Strikethrough section showing removed weight
        context.draw(
            Text("6,935 t").font(RenaissanceFont.bodySmall).foregroundColor(sepiaInk.opacity(0.4)),
            at: CGPoint(x: centerX - barW / 2 + barW * 0.85, y: barY + barH / 2)
        )

        // Summary below
        context.draw(
            Text("–2,400 tons removed by hollowing each panel").font(RenaissanceFont.buttonSmall).foregroundColor(color),
    ...
    private func drawBronzeDoors(context: GraphicsContext, size: CGSize) {
        ...
        if let doorHeight = visual.values["height"] {
            context.draw(
                Text("\(Int(doorHeight))m tall").font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        context.draw(
            Text("bronze").font(RenaissanceFont.italicSmall).foregroundColor(Color.brown.opacity(0.6)),
        ...
        if let melted = visual.values["melted"] {
            context.draw(
                Text("\(Int(melted)) tons melted by Urban VIII").font(RenaissanceFont.buttonSmall).foregroundColor(color),
        ...
        // Pivot label
        context.draw(
            Text("swings on bronze pivots").font(RenaissanceFont.italicSmall).foregroundColor(sepiaInk.opacity(0.5)),
    ...
    private func drawCentering(context: GraphicsContext, size: CGSize) {
        ...
        // "OAK" label
        context.draw(
            Text("oak centering").font(RenaissanceFont.italicSmall).foregroundColor(Color.brown.opacity(0.6)),
        ...
        context.draw(
            Text("wet concrete").font(RenaissanceFont.italicSmall).foregroundColor(Color.red.opacity(0.5)),
        ...
        context.draw(
            Text("holds for 3 weeks → then removed").font(RenaissanceFont.buttonSmall).foregroundColor(color),
    ...
    private func drawMolecule(context: GraphicsContext, size: CGSize) {
        ...
        for (i, atom) in bondedAtoms.enumerated() {
            ...
            context.draw(
                Text(atom).font(RenaissanceFont.bodySmall).foregroundColor(sepiaInk),
                at: CGPoint(x: x, y: y)
            )
        }
        ...
        if currentStep >= 3, let formula = visual.caption {
            context.draw(
                Text(formula).font(RenaissanceFont.buttonSmall).foregroundColor(color),
    ...
    private func drawComparison(context: GraphicsContext, size: CGSize) {
        ...
        for (i, line) in leftLines.enumerated() {
            let font: Font = i == 0 ? RenaissanceFont.buttonSmall : RenaissanceFont.bodySmall
        ...
        context.draw(
            Text(arrowLabel).font(RenaissanceFont.italicSmall).foregroundColor(color.opacity(0.7)),
