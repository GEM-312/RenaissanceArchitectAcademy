...
1. Read `RenaissanceArchitectAcademy/Models/LessonContent.swift` for the router pattern
2. Read `RenaissanceArchitectAcademy/Models/LessonContentRome.swift` or `LessonContentRenaissance.swift` for examples
3. Read `RenaissanceArchitectAcademy/Models/BuildingLesson.swift` for section types
